    ...
    render() {
      return (
          <View style={{flex:1,alignItems: 'center', justifyContent:'center'}}>
              <View style={{flex:1,alignItems: 'center', justifyContent:'center',width:'90%',marginTop:30}}>
                <Text style={{fontSize:30,fontWeight:'bold',alignSelf:'flex-start'}}>Tell us about your music taste.</Text>
                <Text style={{fontSize:18,alignSelf:'flex-start'}}>How do you feel about...</Text>
