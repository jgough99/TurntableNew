    ...
    render() {
      return (
          <View style={{flex:1,alignItems: 'center', justifyContent:'center'}}>
              <Text style={{marginBottom:20,fontSize:20,fontWeight:'bold'}}>{this.props.title} </Text>
            ...
            <View style={{flex:1,alignItems: 'stretch'}}>
                ...
                <Slider
                    ...
                    thumbStyle={{borderRadius:15, backgroundColor:'white',borderColor:'#CDCBCB',borderWidth:1,width:40,height:40}}
